...
const artworks: Artwork[] = [
  ...
  },
  {
    ...
    subtitle: "孙悟空",
    en: "Monkey King",
    desc: "一根铁棒，挑着不肯低头的命。五行山下五百年，磨平了山，没磨平他。画里那双眼望着的，不是凌霄殿，是殿之外的天。今日欢呼孙大圣，只缘妖雾又重来。",
    enDesc: "An iron staff, bearing a fate that would not bow. Five centuries beneath Five-Elements Mountain — the mountain wore smooth, he did not. In the painting those eyes look not at the Jade Palace, but at the sky beyond it. 'Today we hail the Great Sage Sun, for the demonic mist comes once again.'",
    year: "2026.03.19",
    vertical: true,
  },
  {
