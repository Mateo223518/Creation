...
const artworks: Artwork[] = [
  ...
  },
  {
    ...
    subtitle: "孙悟空",
    en: "Monkey King",
    desc: "画面中央，大圣身外身法现——三头六臂各执金箍棒，棒影翻飞如风雷。锁子黄金甲、豹皮裙、杏黄战袍被罡风卷起，翻飞如焰。朱砂点披风，石青染甲胄，水墨晕染间怒目圆睁。右侧行书题'齐天大圣'四字，笔力与棒势一同贯出纸面。今日欢呼孙大圣，只缘妖雾又重来。",
    enDesc: "At the canvas's heart, the Great Sage multiplies — three heads and six arms, each wielding a golden staff, their blurs streaking like thunder. He wears the chainmail of gold, a leopard-skin kilt, and an apricot-yellow battle cloak whipped up by the gale, flaring like flame. Vermilion touches the cloak, azurite tints the armor; through the ink wash his fierce, wide-eyed glare leaps forth. To the right, running script inscribes 'Great Sage Equal to Heaven' — the brushwork and the staff's sweep breaking from the page together. 'Today we hail the Great Sage Sun, for the demonic mist comes once again.'",
    year: "2026.03.19",
    vertical: true,
  },
  {
