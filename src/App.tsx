...
const artworks: Artwork[] = [
  ...
  },
  {
    ...
    subtitle: "孙悟空",
    en: "Monkey King",
    desc: "一棒横扫，天宫为之倾颓——画的不是神话里的战阵，是一颗不肯向天地低头的心。五行山下五百年，压得住身，压不住那股齐天的气。风雷动处，尽是自由的回响。今日欢呼孙大圣，只缘妖雾又重来。",
    enDesc: "A single staff-sweep and the Heavenly Palace crumbles — this is no mythic battle scene, but a heart that will not bow to heaven itself. Five centuries beneath Five-Elements Mountain could press the body, never the spirit that rivals heaven. Where wind and thunder move, only freedom echoes. 'Today we hail the Great Sage Sun, for the demonic mist comes once again.'",
    year: "2026.03.19",
    vertical: true,
  },
  {
