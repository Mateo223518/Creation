...
const artworks: Artwork[] = [
  ...
  },
  {
    ...
    subtitle: "孙悟空",
    en: "Monkey King",
    desc: "长棍一指，九霄云裂。他不拜天，不惧地，眼里只有一处要去的前方。五百年压在五行山下，风霜蚀尽披挂，蚀不尽的是那双眼——望穿的，是凌霄之外的自在。今日欢呼孙大圣，只缘妖雾又重来。一棒在手，万山让路，那不是神通，是不肯屈身的气。",
    enDesc: "A long staff points, and the clouds of the nine heavens split. He bows to no sky, fears no earth; in his eyes there is only the road ahead. Five centuries pressed beneath Five-Elements Mountain — frost and wind consume the armor, but never that gaze, which looks through to a freedom beyond the Jade Palace. 'Today we hail the Great Sage Sun, for the demonic mist comes once again.' Staff in hand, ten thousand mountains yield the way; that is no magic power, but a spirit that will not be bent.",
    year: "2026.03.19",
    vertical: true,
  },
  {
