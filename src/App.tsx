...
const artworks: Artwork[] = [
  ...
  },
  {
    ...
    subtitle: "孙悟空",
    en: "Monkey King",
    desc: "齐天大圣立于花果山巅，金箍棒横扫九霄，旌旗猎猎作响。他踏碎凌霄的桀骜，是天地间不肯低头的那股气。披挂鲜烈，眼神灼灼——五百年五行山下，也压不灭的，是一颗齐天的心。今日欢呼孙大圣，只缘妖雾又重来。那根千钧棒，原不只为神话里的兵器，更是每个时代里澄清玉宇、斩尽妖雾的底气。",
    enDesc: "The Great Sage stands atop Mount Huaguo, golden staff sweeping the nine heavens, banners cracking in the wind. His defiance that shattered the Heavenly Palace is the one breath in all the world that will not bow. Armor blazing, eyes burning bright — five centuries beneath Five-Elements Mountain could not quench a heart that rivals heaven. 'Today we hail the Great Sage Sun, for the demonic mist comes once again.' That thousand-pound staff was never merely a mythic weapon — it is the resolve in every age to cleanse the heavens and sweep the demons away.",
    year: "2026.03.19",
    vertical: true,
  },
  {
